            ...
            <div class="col-xl-3">
              <div class="shop-sidebar">
                  ...
                  <div class="department_bottom">
                    <ul>
                      @foreach($category as $key => $value)
                        <li> <a class="department-link" href="{{ url('categories') . '/' . $value->id }}">{{ $value->category_name }}</a></li>
                      @endforeach
                    </ul>
                  </div>
                </div>
                    ...
                    <p>
                      ...
                      <div class="filter-group">
                        <div class="container">
                          ...
                          <div class="row slider-labels"  style="margin-top:20px;">
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                              <form action="{{ url('filter') }}" method="GET">
                                <input type="hidden" id="min" name="min-value" value="">
                                <input type="hidden" id="max" name="max-value" value="">
                                <button style="margin-top:20px;" type="submit" class="normal-btn">Fiter</button>
                              </form>
                            </div>
                          </div>
                        </div>
                ...
                <div class="shop-sidebar_tag">
                  ...
                  <div class="tag_bottom"><a class="tag-btn" href="">organic</a><a class="tag-btn" href="">vegatable</a><a class="tag-btn" href="">fastfood</a><a class="tag-btn" href="">natural</a></div>
                </div>
              </div>
...
$(document).ready(function() {
  ...
  rangeSlider.noUiSlider.on('update', function(values, handle) {
    ...
    document.getElementById('min').value = moneyFormat.from(values[0]);
    document.getElementById('max').value = moneyFormat.from(values[1]);
  });
});
